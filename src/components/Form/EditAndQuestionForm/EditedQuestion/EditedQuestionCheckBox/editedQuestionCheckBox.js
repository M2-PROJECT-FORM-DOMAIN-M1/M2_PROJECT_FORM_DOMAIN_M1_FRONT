...
import DialogEditedQuestionCheckBoxAdd from "./DialogEditedQuestionCheckBoxAdd/dialogEditedQuestionCheckBoxAdd";
        ...
        <div>
                                    ...
                                    {(provided, snapshot) => (
                                        ...
                                        >
                                            <div className={style.containerRow}>
                                                ...
                                                />
                                                <DeleteIcon className={style.buttonDelete} onClick={(e) => deletePossibleAnswer(index)}/>
            ...
            <div className={style.bottom}>
                <IconButton onClick={() => dialog.handleOpenDialog({
                    childrenDialog: <DialogEditedQuestionCheckBoxAdd questionEdited={props.questionEdited} setQuestionEdited={props.setQuestionEdited}
                                                                     dialog={dialog}/>,
                    direction: "down"
                })}>
                    <AddCircleIcon className={style.addCircleIcon}/>
                </IconButton>
                <Button onClick={()=>{props.handleSaveEditedQuestion()}}  className={style.saveButton} variant={"contained"}>
                    Save
                </Button>
            </div>
        </div>
